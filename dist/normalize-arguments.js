...
const preNormalize = (options, defaults) => {
    ...
    if (is.nonEmptyObject(defaults) && retry !== false) {
        options.retry = Object.assign({}, defaults.retry);
    }
    if (retry !== false) {
        if (is.number(retry)) {
            ...
            options.retry = Object.assign({}, options.retry, retry);
        }
    }
...
const normalize = (url, options, defaults) => {
    ...
    if (options.hostname === 'unix') {
        ...
        if (matches) {
            ...
            options = Object.assign({}, options, { socketPath,
                path, host: null });
        }
    }
...
//# sourceMappingURL=normalize-arguments.js.map